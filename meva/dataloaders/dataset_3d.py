...
class Dataset3D(Dataset):
    ...
    def get_single_item(self, index):
        ...
        if self.dataset_name == '3dpw' or self.dataset_name == 'surreal' or self.dataset_name == 'amass_rend_take3' or self.dataset_name == 'movi':
            ...
            pose  = self.db['pose'][start_index:end_index+1]
            shape = self.db['shape'][start_index:end_index+1]
            w_smpl = torch.tensor(self.db['has_smpl'][start_index:end_index+1]).float()
            w_3d = torch.ones(self.seqlen).float()
        elif self.dataset_name == 'mpii3d':
        ...
        if ( self.dataset_name == 'amass_rend_take3' or self.dataset_name == 'movi' or self.dataset_name == '3dpw' or self.dataset_name == 'surreal') and not is_train:
